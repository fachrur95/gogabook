...
const title = "Stock Opname Counts";
const path: WorkerPathType = "opname-counts";
...
const StockOpanameCountsPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default StockOpanameCountsPage;
StockOpanameCountsPage.Layout = "Dashboard";
