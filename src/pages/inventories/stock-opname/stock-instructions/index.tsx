...
const title = "Stock Opname Instruction";
const path: WorkerPathType = "stock-instructions";
...
const StockOpanameInstructionsPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default StockOpanameInstructionsPage;
StockOpanameInstructionsPage.Layout = "Dashboard";
