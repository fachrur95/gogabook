...
import { stockAdjustmentTabs } from "@/components/tabs/data";
// import { LoadingPage } from "@/components/layouts/LoadingPage";
// import useNotification from "@/components/hooks/useNotification";

const sortDefault: GridSortModel = [{ field: "trans_entrydate", sort: "desc" }];

const title = "Stock Opname Adjustments";
const path: WorkerPathType = "stock-adjustments";
...
const StockOpanameAdjustmentsPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
  ...
  const {
    ...
    refetch,
    isFetching,
  } = api.stockAdjustment.getAll.useInfiniteQuery(
    {
      type: path,
      limit: 150,
      q: search,
  ...
  return (
    <>
      ...
      <Box className="flex flex-col gap-2">
        <NavTabs data={stockAdjustmentTabs} />
        <Box
          component={Paper}
          elevation={4}
...
export default StockOpanameAdjustmentsPage;
StockOpanameAdjustmentsPage.Layout = "Dashboard";
