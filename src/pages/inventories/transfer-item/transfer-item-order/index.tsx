...
const title = "Transfer Item Orders";
const path: WorkerPathType = "transfer-item-order";
...
const TransferItemOrdersPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default TransferItemOrdersPage;
TransferItemOrdersPage.Layout = "Dashboard";
