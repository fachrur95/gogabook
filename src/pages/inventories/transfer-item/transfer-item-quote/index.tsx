...
const title = "Transfer Item Quotations";
const path: WorkerPathType = "transfer-item-quote";
...
const TransferItemQuotesPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default TransferItemQuotesPage;
TransferItemQuotesPage.Layout = "Dashboard";
