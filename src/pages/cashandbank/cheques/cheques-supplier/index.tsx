...
const title = "Cheque Suppliers";
const path: WorkerPathType = "payable-payments";
...
const ChequeSuppliersPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default ChequeSuppliersPage;
ChequeSuppliersPage.Layout = "Dashboard";
