...
const title = "Disassembly Quotations";
const path: WorkerPathType = "disassembly-quote";
...
const DisassemblyQuotesPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default DisassemblyQuotesPage;
DisassemblyQuotesPage.Layout = "Dashboard";
