...
const title = "Disassembly Orders";
const path: WorkerPathType = "disassembly-order";
...
const DisassemblyOrdersPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
DisassemblyOrdersPage.Layout = "Dashboard";
