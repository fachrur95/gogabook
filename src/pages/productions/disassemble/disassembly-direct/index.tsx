...
import { disassemblyTabs } from "@/components/tabs/data";
// import { LoadingPage } from "@/components/layouts/LoadingPage";
// import useNotification from "@/components/hooks/useNotification";

const sortDefault: GridSortModel = [{ field: "trans_entrydate", sort: "desc" }];

const title = "Disassembly Directs";
const path: WorkerPathType = "disassembly-direct";
...
const DisassemblyDirectsPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
  ...
  const {
    ...
    refetch,
    isFetching,
  } = api.production.getAll.useInfiniteQuery(
    {
      type: path,
      limit: 150,
      q: search,
...
export default DisassemblyDirectsPage;
DisassemblyDirectsPage.Layout = "Dashboard";
