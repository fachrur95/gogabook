...
const title = "Assembly Orders";
const path: WorkerPathType = "assembly-order";
...
const AssemblyOrdersPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
AssemblyOrdersPage.Layout = "Dashboard";
