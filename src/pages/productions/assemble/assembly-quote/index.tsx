...
const title = "Assembly Quotations";
const path: WorkerPathType = "assembly-quote";
...
const AssemblyQuotesPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default AssemblyQuotesPage;
AssemblyQuotesPage.Layout = "Dashboard";
