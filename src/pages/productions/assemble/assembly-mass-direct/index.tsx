...
import { assemblyTabs } from "@/components/tabs/data";
// import { LoadingPage } from "@/components/layouts/LoadingPage";
// import useNotification from "@/components/hooks/useNotification";

const sortDefault: GridSortModel = [{ field: "trans_entrydate", sort: "desc" }];

const title = "Assembly Mass Directs";
const path: WorkerPathType = "assembly-mass-direct";
...
const AssemblyMassDirectsPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
  ...
  const {
    ...
    refetch,
    isFetching,
  } = api.massProduction.getAll.useInfiniteQuery(
    {
      type: path,
      limit: 150,
      q: search,
...
export default AssemblyMassDirectsPage;
AssemblyMassDirectsPage.Layout = "Dashboard";
