...
const title = "Assembly Directs";
const path: WorkerPathType = "assembly-direct";
...
const AssemblyDirectsPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default AssemblyDirectsPage;
AssemblyDirectsPage.Layout = "Dashboard";
