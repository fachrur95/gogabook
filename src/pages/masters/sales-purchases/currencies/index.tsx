...
const title = "Master Currencies";
const path: WorkerPathType = "exchange";
...
const MasterCurrenciesPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default MasterCurrenciesPage;
MasterCurrenciesPage.Layout = "Dashboard";
