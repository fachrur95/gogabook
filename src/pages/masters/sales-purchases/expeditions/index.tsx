...
const title = "Master Expeditions";
const path: WorkerPathType = "expedition";
...
const MasterExpeditionPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default MasterExpeditionPage;
MasterExpeditionPage.Layout = "Dashboard";
