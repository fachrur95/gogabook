...
const title = "Master Unit Of Measurements";
const path: WorkerPathType = "uom";
...
const MasterUnitOfMeasurementsPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
export default MasterUnitOfMeasurementsPage;
MasterUnitOfMeasurementsPage.Layout = "Dashboard";
