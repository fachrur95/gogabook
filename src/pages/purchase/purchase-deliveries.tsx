...
const title = "Purchase Delivery";
const path: WorkerPathType = "purchase-delivery";
...
const PurchaseDeliveriesPage: MyPage<{ sessionData: ISessionData }> = ({
  sessionData,
}) => {
...
PurchaseDeliveriesPage.Layout = "Dashboard";
