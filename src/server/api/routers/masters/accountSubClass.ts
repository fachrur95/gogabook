...
import type { IMasterAccountSubClass } from "@/types/masters/masterChartOfAccount/masterAccountSubClass";
// import { getServerSession } from "next-auth";

export const defaultUndefinedResult: InfiniteQueryResult<IMasterAccountSubClass> = {
  result: [],
  count: 0,
  countAll: 0,
  currentPage: 0,
...
export const masterAccountSubClassRouter = createTRPCRouter({
